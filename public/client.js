...
var colors = ["#eff6fd","#d8e9fa","#bed0e9","#eb5c74","#fdeef1","#27c4ff","#49d9ff","#b3b6ff","#b1d4ff","#b9f2ff"];
    ...
    socket.on('color', function() { // on a 'reset' message clean and reste firstMessage
      COLOUR = colors[Math.floor(Math.random() * 10)];
